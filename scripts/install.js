...
eyesarr = ['⌐■ ■', 'ᗒ ᗕ', '° °', 'ʘ ʘ', '◕ ◕', 'ŏ ŏ', '´• •`', 'º º', '･ิ ･ิ', '^ ^', 'ー ー', '~ ~', '◠ ◠', '° o', '♡ ♡', '- -', '❦ ❦', 'ಥ ಥ', '≖ ≖', '´ `', 'T T', '´- -`', '･ิ ･ิ', '･ั ･ั', '→ →', '• •', '✧ ✧', '✪ ✪', '► ◄', 'ᴗ ᴗ', '@ @', '◎ ◎', '⊃ ⊂', '☼ ☼', '〇 〇', 'Ω Ω', '☭ ☭', '$ $', '⎚ ⎚', '👁️ 👁️', '⚈ ⚈', '◭ ◭', '¬ ¬', 'Ⓘ Ⓘ', '⊗ ⊗', '🔥 🔥', '* *'];
earsarr = ['( )', '¯\\_( )_/¯', '[ ]', 'ᕙ( )ᕗ', '(∩ )⊃━☆ﾟ.*', 'ᕕ( )ᕗ', '(づ )づ', '(✿ )', 'ʕ ʔ', '(メ )', '( )♡', '凸( )凸', '٩( )۶', 'm( )m', '(ง )ง', '(✧ )', '(ლ )ლ', '乁( )ㄏ', '☞ ☞', '(╭☞ )╭☞', '⤜( )⤏', 'ᕦ ᕥ', '⸮ ?', 'ᕮ ᕭ', '| |', '﴾ ﴿', 'ᘳ ᘰ', 'ʢ ʡ', '( )¤=[]:::::>', '( )つ──☆*', '( )︻̷┻̿═━一-', '(∩ )⊃-(===>', '(˵ ˵)ﾉ⌒♡*:。', '(˵ ˵)ᓄ✂', '┐( )┌', '(. .)', '( )✌', '( )👌', '(👍 )👍', '(╯ )╯┻━┻', '(っ )っ🎔', '[̲̅$̲̅( )̲̅$̲̅]', '🖕( )', '✍( )']
mouthsarr = ['͟ʖ', 'ᗝ', '>', 'ᴥ', ' ͟ʖ', '▽', 'o', '‿', 'ω', '﹏', '오', 'ゝ', 'д', '^', ' ͜ つ', 'ʖ̯ ', '_ゝ', '﹏', 'ل͜', 'ڡ', 'ε', 'ө', 'ᨓ', 'ᨎ', '˛', '╭╮', '෴', '⍘', '👅', '~͜ʖ~', '⊱', 'ε', ' ͜U', ' ͜ 𐭃', 'ᴗ', '⏥', '⏏', '.', 'ₒ', '₃', '●', '皿'];
